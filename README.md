...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libxtst-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libxtst-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libxtst
# for installing globally
pixi global install xorg-libxtst
```
...
It is possible to list all of the versions of `xorg-libxtst` available on your platform:
...
```
pixi search xorg-libxtst --channel conda-forge
```
